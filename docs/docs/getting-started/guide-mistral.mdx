...
```shell
go run github.com/Ideful/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://github.com/Ideful/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
